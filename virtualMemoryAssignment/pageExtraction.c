...
void processLogicalAddress(FILE *input_fp, FILE *backingSTORE_fp, FILE *output_fp, int *pagetable,  int TLB[TLB_SIZE][2], char *ramMem);
...
int main(int argc, const char *argv[]) {
   ...
   processLogicalAddress(input_fp, backingSTORE_fp, output_fp, pagetable, TLB, (char*)ramMem);
    return 0;
}
